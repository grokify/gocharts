...
func ParseFileCSV(file string, name string, binNameColIdx, binFrequencyColIdx uint32) (*Histogram, error) {
...
// skipped.
func ParseTable(tbl table.Table, binNameColIdx, binFrequencyColIdx uint32) (*Histogram, error) {
